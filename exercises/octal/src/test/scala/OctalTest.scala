...
class OctalTest extends FlatSpec with Matchers {
  "octalToInt" should "empty string should error" in {
    intercept[IllegalArgumentException] {
      Octal.octalToInt("")
    }
  }

  it should "handle invalid octal" in {
    intercept[IllegalArgumentException] {
  ...
  it should "handle leading and trailing spaces" in {
    Octal.octalToInt(" -10  \n") should equal(-8)
  }

  it should "handle overflow" in {
    intercept[IllegalArgumentException] {
      Octal.octalToInt("777777777777777777")
    }
  }

  "int2Octal" should "handle Int 0" in {
